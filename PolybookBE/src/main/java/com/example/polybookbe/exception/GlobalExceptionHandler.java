...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> validationHandler(MethodArgumentNotValidException ex) {
        ...
        response.put("code", "VALIDATION_ERROR"); // fix typo
        response.put("message", "Dữ liệu không hợp lệ"); // message chung
    ...
    public ResponseEntity<?> allOtherExceptionHandler(Exception ex) {
        ...
        response.put("message", "Lỗi hệ thống"); // không nên trả ex.getMessage()
